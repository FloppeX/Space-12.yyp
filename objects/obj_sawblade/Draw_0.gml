...
owner_dir = scr_wrap_direction_to_closest_instance(owner)+180 //point_direction(owner.phy_position_x,owner.phy_position_y,phy_position_x,phy_position_y)
owner_dist = scr_wrap_closest_distance_to_instance(owner)//point_distance(phy_position_x,phy_position_y,owner.phy_position_x,owner.phy_position_y)
