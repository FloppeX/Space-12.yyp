...
sprite_index = spr_shop_structure_d

shop_segments[1] = instance_create_depth(x-50,y-35,10,obj_shop_segment);
...
shop_segments[2] = instance_create_depth(x+50,y-35,10,obj_shop_segment);
...
shop_segments[3] = instance_create_depth(x-50,y+35,10,obj_shop_segment);
...
shop_segments[4] = instance_create_depth(x+50,y+35,10,obj_shop_segment);
