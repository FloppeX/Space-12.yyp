...
for(var i = wormhole_segments; i > 0; i-=1;){
	...
	draw_sprite_ext(spr_wormhole,-1,draw_position_x,draw_position_y,2*global.gui_scale * temp_scale,2*global.gui_scale * temp_scale,/*rotation_dir_shifter*/ 0.5 * i * (rotation-i*30),color,1)
	}
