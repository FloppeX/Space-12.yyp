...
if scr_exists(my_sawblade){
	if phy_position_x - my_sawblade.phy_position_x > 300
		my_sawblade.phy_position_x += global.play_area_width
	if phy_position_x - my_sawblade.phy_position_x < -300
		my_sawblade.phy_position_x -= global.play_area_width
	if phy_position_y - my_sawblade.phy_position_y > 300
		my_sawblade.phy_position_y += global.play_area_height
	if phy_position_y - my_sawblade.phy_position_y < -300
		my_sawblade.phy_position_y -= global.play_area_height
}
/*
