...
if alignment == "left"{
	...
	if menu_active == true
		draw_rectangle(x_pos-marker_offset_h,y_pos+selected_item*item_distance- global.gui_scale * 0.5 * string_height(menu_items[selected_item]) - marker_offset_v,x_pos+string_width(menu_items[selected_item])+marker_offset_h,y_pos+ selected_item*item_distance+global.gui_scale * 0.5 * string_height(menu_items[selected_item])+marker_offset_v,true)
	}
