function scr_create_random_enemy(argument0) {
	var enemy_type = argument0
	var temp_x = global.wrap_border_left + random(global.play_area_width)
	var temp_y = global.wrap_border_top + random(global.play_area_height)
	...
	new_enemy = instance_create_depth(temp_x,temp_y,0,enemy_type);
