function scr_create_random_module_old() {
	var h = irandom(16)
		switch (h){
			...
			case 16: temp_module = instance_create_depth(0,0,-10,obj_crew_new_rock_man);break;
			}
	...
	if object_is_ancestor(temp_module.object_index, obj_module_device)
