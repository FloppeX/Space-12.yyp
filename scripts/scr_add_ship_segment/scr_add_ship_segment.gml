function scr_add_ship_segment(argument0, argument1, argument2) {
	var ship = argument0
		...
		if segment_placed == false{
			for(var i = 0; i < number_of_segments; i+=1;)
				if segment_placed == false {
					...
					if direction_randomizer >= 0 and direction_randomizer <= 39{
					...
					if direction_randomizer >= 40 and direction_randomizer <= 49{
					...
					if direction_randomizer >= 50 and direction_randomizer <= 59{
						temp_x = ship.ship_segment[i].phy_position_x+lengthdir_x(segment_distance,-ship.phy_rotation+90)
						temp_y = ship.ship_segment[i].phy_position_y+lengthdir_y(segment_distance,-ship.phy_rotation+90)
						if !instance_place(temp_x,temp_y,segment_type){
							new_segment = instance_create_depth(temp_x,temp_y,-1,segment_type)
					...
					if direction_randomizer >= 59 and direction_randomizer <= 99{
